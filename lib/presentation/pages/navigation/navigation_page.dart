...
class _NavigationPageState extends State<NavigationPage> {
  ...
  void _toggleNavigationLock(LatLng? currentPos) {
    ...
    if (_isNavigationLocked && currentPos != null) {
       ...
       _mapController.animateTo(dest: currentPos, zoom: 18); // Zoom in for navigation mode
    }
  }
    ...
    if (permission == LocationPermission.deniedForever) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
           SnackBar(content: Text('permission_required'.tr())),
        );
      }
    }
  }
          ...
          body: BlocConsumer<TrackingBloc, TrackingState>(
            ...
            builder: (context, state) {
              ...
              return Stack(
                children: [
                  ...
                  Positioned(
                     ...
                     child: Column(
                       ...
                       children: [
                         _buildInfoChip(context, Icons.speed, '$speedKmh km/h', 'device_speed'.tr()),
                       const SizedBox(height: 8),
                       _buildInfoChip(context, Icons.explore, '${heading.toStringAsFixed(0)}°', 'device_heading'.tr()),
                     ],
                   )
                ),
                    ...
                    child: Autocomplete<Map<String, dynamic>>(
                      ...
                      optionsViewBuilder: (context, onSelected, options) {
                        return Align(
                          ...
                          child: Material(
                            ...
                            child: Container(
                              width: MediaQuery.of(context).size.width - 96, // Adjust width
                      ...
                      onSelected: (suggestion) {
                        if (currentLatLng != null) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                             SnackBar(
                              content: Text('map_waiting_gps'.tr()),
                            ),
                          );
                        }
                      },
                ...
                Positioned(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.settings_outlined, color: Theme.of(context).iconTheme.color),
                    ),
                  ),
                ),
                      ...
                      Row(
                        children: [
                          FloatingActionButton.small(
                            ...
                            onPressed: () => _toggleNavigationLock(currentLatLng),
                            backgroundColor: _isNavigationLocked ? Colors.blue : Theme.of(context).cardColor,
                            child: Icon(
                              _isNavigationLocked ? Icons.navigation : Icons.navigation_outlined,
                              color: _isNavigationLocked ? Colors.white : Theme.of(context).iconTheme.color,
                            ),
                          ),
                          FloatingActionButton.small(
                              heroTag: 'locate_me',
                ...
                if (_route != null && _route!.isNotEmpty && _destination != null)
                  Positioned(
                    bottom: 30,
                    left: 16,
                    right: 16,
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Text('Next Turn', style: TextStyle(fontSize: 10, color: Theme.of(context).textTheme.bodySmall?.color))
                                  ],
                                ),
                                  ...
                                  onPressed: () async {
                                    final confirmed = await showDialog<bool>(
                                      ...
                                      builder: (context) => AlertDialog(
                                        ...
                                        content: Text('nav_stop_message'.tr()),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.of(context).pop(false),
                                            child: Text('cancel'.tr()),
                                          ...
                                          TextButton(
                                            onPressed: () => Navigator.of(context).pop(true),
                                            child: Text('stop'.tr(), style: const TextStyle(color: Colors.red)),
                                          ),
                                        ],
                                      ),
                                    );
     ...
     return Container(
       ...
       child: Row(
         ...
         children: [
           ...
           Text(value, style: TextStyle(fontWeight: FontWeight.bold, color: Theme.of(context).textTheme.bodyMedium?.color)),
